        ...
        for root in self._links:
            ...
            for v in range(len(self._links_inertial_info[root_local])):
                ...
                for link in subtree:
                    ...
                    for geom in geoms:
                        pos, quat = gu.transform_pos_quat_by_trans_quat(
                            geom._init_pos, geom._init_quat, alignment_pos, alignment_quat
                        )
                ...
                if isinstance(root, RigidLink):
                    ...
                    real_total = sum(
                        float(link._variant_inertial[v].mass if is_heterogeneous else link.inertial_mass)
                    ...
                    for link in subtree:
                        if link is root:
                            ...
                            if is_heterogeneous:
                                ...
                                pos, quat = link.inertial_pos, link.inertial_quat
